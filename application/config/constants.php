...
define('ORGAN_RESERVE_MODE_TYPE_SHIFT', 1);
define('ORGAN_RESERVE_MODE_TYPE_STAFF', 0);

define('SQUARE_ENDPOINT_HOST', 'https://connect.squareupsandbox.com/');

define('EPARK_BASE_URL', 'https://dev.peakmanager.com');
$epark_apis = [
    'auth' => "/mi_api/app/SPConnect/auth",
];
define('EPARK_FUNCTIONS', $epark_apis);
