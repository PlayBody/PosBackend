                ...
                <div class="form-select-list">
                    <select id="sel_organ_id" class="form-control custom-select-value" >
                        <?php foreach ($organs as $organ){ ?>
                            <option value="<?php echo $organ['organ_id']; ?>" <?php if ($organ_id==$organ['organ_id']){ echo 'selected'; }?> >
...
<script src="<?php echo base_url(); ?>assets/js/shift/main_content.js"></script>
<script src="<?php echo base_url(); ?>assets/js/epark/scheduler-left-nav.js"></script>

<?php include 'shift_modal.php'; ?>
